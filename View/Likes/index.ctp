<div class="likes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('send_user_id'); ?></th>
			<th><?php echo $this->Paginator->sort('receive_user_id'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($like['Like']['send_user_id']); ?>&nbsp;</td>
		<td><?php echo h($like['Like']['receive_user_id']); ?>&nbsp;</td>
